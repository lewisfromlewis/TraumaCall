...
mantelhaen.test(traumata$`Major Trauma`, traumata$`GCSunder13`, traumata$`SaO2<90`)
...
bulkmodel <- glm(formula = `Major Trauma`=='yes' ~ `multi?` +  
    ...
    `RR>30` + `SaO2<90` + 
    `Resp distr` + Flail + `GCSunder13` + Agitated + 
    Seizure + `Sig Inj ≥2` , 
