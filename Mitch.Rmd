...
collapsed_correlations <- apply(traumata[,81:107], 2, cor, traumata[,81:107], use = "pair")
...
ISSmodel <- glm(formula = traumata$ISS_over_15 ~ names(traumata)[c(9, 22:24, 26, 28, 29, 32, 37, 39:41, 46, 48, 50, 51, 56, 58, 59:61, 63:66, 68, 69)],
                family = "binomial", data = traumata)
ISSbdsummary <- summary(ISSmodel)
